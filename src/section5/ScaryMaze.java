...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {public static void main1(String[] args) {
	...
	public void mouseMoved(MouseEvent e) {
		...
		if(mouseColor ==  -16738680) {
			JOptionPane.showMessageDialog(null,("u win good job"));
		}
